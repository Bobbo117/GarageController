...
//  #define GARAGE
    ...
    const long sensorSeconds = 600;        // interval in seconds to refresh time sensitive sensor readings 
...
//   6. publishMQTT();             // NOTE: publishMQTT() is called from within the ESPNOW Callback function so it updates HA only when new data is received.  
